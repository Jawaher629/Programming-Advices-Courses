//My solution with slight difference from Dr.Abu Hadhoud's solution.
#include <iostream>
#include <string>
#include <vector>
#include <fstream>
...
enum enUserChoices { ClientList = 1, AddNewClient = 2, DeleteAccount = 3, UpdateClient = 4, FindClient = 5, Transaction = 6, Exit = 7};
