...
void SumColsInArray(int arr1[3][3], int arrSum[3], short Rows, short Columns)
{
	for (short i = 0; i < Columns; i++)
	{
		arrSum[i] = SumEachColumnInMatrix(arr1, 3, i);
	}
}

void PrintColumnsSumArray(int arrSum[3], short Columns)
{
...
int main()
{
	...
	SumColsInArray(arr1, arrSum, 3, 3);
